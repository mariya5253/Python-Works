...
def token_maker(tweet):
	# print("tokenizer fncn called")
...
def result():
	...
	with graph1.as_default():
		...
		my_model = load_model('./models/rnn_no_embeddings/weights-improvement-02-0.8963.hdf5')
		...
		if request.method == 'POST':
			...
			# print("comment:")
			# print(data['text'])
			data['tokens'] = data.text.progress_map(token_maker)
			# print(data['tokens'])
